...
class CurrencyServiceProviderException extends Services\ExceptionAdapter {
    ...
    public function __construct($kernel, $message, $code = 101103, \Exception $previous = null) {
        parent::__construct(
            $kernel,
            'Currency conversion service with the code "'.$message.'" cannot be found. Make sure that the necessary driver is installed in CurrencyBundle\\Drivers\\ServiceProviders',
            $code,
            $previous
        );
    }
