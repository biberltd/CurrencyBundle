...
class CurrencyCodeException extends Services\ExceptionAdapter {
    ...
    public function __construct($kernel, $message = "", $code = 101100, Exception $previous = null) {
        parent::__construct(
            $kernel,
            'The currency with the code "'.$message.'" cannot be found. Please make sure that the corresponding driver has been installed in CurrencyBundle\\Drivers\\Currencies folder.',
            $code,
            $previous);
     }
}
